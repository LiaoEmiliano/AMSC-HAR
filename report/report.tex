...
\texttt{ucf11\_videocnn.harw} classified $8/10$ randomly drawn clips
...
\paragraph{Test datasets} To evaluate the performance of the VideoCNN model, we used the following datasets : UCF101, HMDB51 and Kinetics.
...
essential for the held-out inference tests in Section~\ref{sec:exp}.
